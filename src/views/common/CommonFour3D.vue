...
const filter01 = new URL('@resource/filter/01_filter.png', import.meta.url)
const filter02 = new URL('@resource/filter/02_filter.png', import.meta.url)
const filter03 = new URL('@resource/filter/03_filter.png', import.meta.url)
const filter04 = new URL('@resource/filter/04_filter.png', import.meta.url)
const filter05 = new URL('@resource/filter/05_filter.png', import.meta.url)
