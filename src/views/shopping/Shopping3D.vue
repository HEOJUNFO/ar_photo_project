<template>
    <div>
        ...
        <div class="bg-container">
            ...
            <img src="@resource/shopping/trash1.png" :class="{ 'fade-out': isChanging }" />
            <img v-if="isChanging" src="@resource/shopping/trash2.png" class="fade-in"
                :class="{ 'fade-out2': isChanging2 }" />
            <img v-if="isChanging2" src="@resource/shopping/trash3.png" class="fade-in2"
                :class="{ 'fade-out3': isChanging3 }" />
            <img v-if="isChanging3" src="@resource/shopping/trash4.png" class="fade-in3" />
...
.dragging-guide {
    animation: dragDropGuide 4s infinite;
}
