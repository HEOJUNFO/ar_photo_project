<template>
    <div class="capture-preview">
        ...
        <div class="bottom-section">
            ...
            <button v-if="!clear" class="share-button" @click="shareImage(), premiumModal = true"><svg
    ...
    setup() {
        ...
        onMounted(() => {
            ...
            imageObj.onload = () => {
                ...
                const imageHeight = window.innerHeight * 0.70;
            ...
            localStorage.getItem('clearId6') === 'true' ? clear.value = true : clear.value = false
        });
