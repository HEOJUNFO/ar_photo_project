            ...
            <div class="top-section2">
                ...
                <div class="right">
                    <div v-if="currentTool === 'draw'" class="top-buttons">
                        <button @click="setDrawingTool('pen')"><svg xmlns="http://www.w3.org/2000/svg" width="20"
                        ...
                        <button @click="setDrawingTool('highlighter')"><svg xmlns="http://www.w3.org/2000/svg" width="20"
                                height="20" viewBox="0 0 20 20" fill="none">
                                <g opacity="0.3">
                        ...
                        <button @click="setDrawingTool('eraser')"><svg xmlns="http://www.w3.org/2000/svg" width="20"
                                height="20" viewBox="0 0 20 20" fill="none">
                                <g opacity="0.3">
                    ...
                    <div v-if="currentTool === 'text'" class="top-buttons">
                        <button @click="setTextTool('normal')"><svg xmlns="http://www.w3.org/2000/svg" width="14"
                        ...
                        <button @click="setTextTool('bold')"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                        ...
                        <button @click="setTextTool('underline')"><svg xmlns="http://www.w3.org/2000/svg" width="20"
                                height="20" viewBox="0 0 20 20" fill="none">
                                <g opacity="0.3">
