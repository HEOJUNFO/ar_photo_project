 ...
 * Original file: /npm/tracking@1.1.3/build/tracking-min.js
 *
...
!function(t, r) {
    ...
    navigator.mediaDevices.getUserMedia || (navigator.mediaDevices.getUserMedia = navigator.mediaDevices.getUserMedia || navigator.webkitGetUserMedia || navigator.mozGetUserMedia || navigator.msGetUserMedia)
}(window),
function() {
    ...
    tracking.Fast.isCorner = function(t, r, n) {
        ...
        for (var e = 0; 16 > e; e++) {
            for (var i = !0, a = !0, o = 0; 9 > o; o++) {
                var c = r[e + o & 15];
                if (!this.isBrighter(t, c, n) && (a = !1, i === !1))
                    break;
                if (!this.isDarker(t, c, n) && (i = !1, a === !1))
                    break
            }
            if (a || i)
                return !0
...
function() {
    tracking.ObjectTracker = function(t) {
        ...
        t && (Array.isArray(t) || (t = [t]), Array.isArray(t) && t.forEach(function(r, n) {
